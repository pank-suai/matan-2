...
#grid(
  ...
  [
    ...
    #align(center)[Назовём $Delta z_x$ частным приращением]
...
- $S$ -- поверхность заданная уравнением $z=f(x,y)$, где $f(x,y)$ -- функция, непрерывная в некоторой области $D$ и имеющая производные по $x$ и $y$.

- касательные(жирные линии) и есть частные производные функции
